...
## keyCount (integer)
The amount of physical keys required for the database. 

In case a database can be applied to multiple different keyboards with varying amount of physical keys, pick the minimum amount of keys required; no ranges.
