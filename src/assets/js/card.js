...
function card(post, postUrl) {
  ...
  <div class="postcard">
      <div class="rounded shadow-lg h-full bg-gray-50 hover:shadow-xl">
          ...
          src="/11tyTailwindDatabase/${post.documentImage}"
          width="960"
          height="500"
          alt="${post.imageAlt}">
          </a>
          <div class="px-6 py-5">
              ...
              <div class="my-5 flex flex-wrap justify-between">
                  ...
                  <p id="artworkName-table-cell-${post.fileSlug}" class="text-gray-700 mb-1 max-w-3/5 break-words text-right">${post.artworkName}</p>
                  ...
                  <p id="repositoryName-table-cell-${post.fileSlug}" class="text-gray-700 mb-1 max-w-3/5 break-words text-right">${post.repositoryName}</p>
              </div>
              ${summary}
          </div>
      </div>
